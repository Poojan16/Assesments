...
export default function AddTeacherForm() {
  ...
  const qualificationOptions = [
    { label: 'Bachelor of Education', value: 'B.Ed' },
    { label: 'Master of Education', value: 'M.Ed' },
    { label: 'Bachlor of Arts', value: 'B.A' },
    { label: 'Master of Arts', value: 'M.A' },
    { label: 'Bachelor of Science', value: 'B.Sc' },
    { label: 'Master of Science', value: 'M.Sc' },
    { label: 'Doctor of Philosophy', value: 'Ph.D' },
    { label: 'Master of Philosophy', value: 'M.Phil' },
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    className={`w-full px-4 py-4 border bg-white ${errors.gender ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition`}
                  >
